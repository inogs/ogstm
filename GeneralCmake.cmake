...
elseif (MPI_Fortran_COMPILER MATCHES "mpif90.*")
  ...
  if (CMAKE_C_COMPILER MATCHES "nvc")
    set (CMAKE_Fortran_FLAGS_RELEASE " -O2 -Mpreprocess -g -acc -gpu=cc70,cuda11.5")
    set (CMAKE_Fortran_FLAGS_DEBUG   " -O1 -Mpreprocess -g -acc -gpu=cc70,cuda11.5,autocompare")
  else()
