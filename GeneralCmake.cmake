...
elseif(CMAKE_Fortran_COMPILER_ID MATCHES "GNU")
    ...
    set(CMAKE_Fortran_FLAGS_DEBUG   "-cpp -Og -g3 -ggdb -Wall -Wextra -fno-omit-frame-pointer -fbounds-check -fimplicit-none -pedantic -ffpe-trap=invalid,zero,overflow")
...
elseif(CMAKE_Fortran_COMPILER_ID MATCHES "NVHPC|PGI")
    ...
    set(CMAKE_Fortran_FLAGS_DEBUG "-g -traceback -acc -gpu=cc70,pinned,debug -Mbounds -Mextend -Mpreprocess -Minfo=all")
else()
