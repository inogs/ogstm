...
elseif(CMAKE_Fortran_COMPILER_ID MATCHES "NVHPC")
    set(CMAKE_Fortran_FLAGS_RELEASE " -g -fast -O3 -acc=strict -ta=tesla:cc70,host,pinned -Mextend -Mpreprocess -Minfo=accel")
    set(CMAKE_Fortran_FLAGS_RELEASE " -g -O1 -acc=strict -ta=tesla:cc70,host,autocompare -Mextend -Mpreprocess -Minfo=accel")
else()
