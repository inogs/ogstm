...
elseif(CMAKE_Fortran_COMPILER_ID MATCHES "NVHPC|PGI")
    ...
    set(CMAKE_Fortran_FLAGS_DEBUG "-O0 -g -traceback -acc -gpu=pinned,debug -Mbounds -Mextend -Mpreprocess -Minfo=all")
else()
...
set(FOLDERS BIO  General  IO  MPI  namelists  PHYS BC)
    ...
    file(GLOB SRCFOLDER src/${FOLDER}/*)
    foreach(SOURCEFILE ${SRCFOLDER})
        if(NOT (${SRCFILE} MATCHES "test_.*"))
            list(APPEND FORTRAN_SOURCES ${SRCFILE})
        endif()
    endforeach()
endforeach()
