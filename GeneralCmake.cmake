...
elseif(CMAKE_Fortran_COMPILER_ID MATCHES "NVHPC|PGI")
    set(CMAKE_Fortran_FLAGS_RELEASE "-fast -acc=strict -ta=tesla:cc70,pinned,host -Mextend -Mpreprocess")
    set(CMAKE_Fortran_FLAGS_DEBUG "-g -traceback -acc=strict -ta=tesla:cc70,pinned,debug,autocompare,host -Mextend -Mpreprocess -Minfo=all")
else()
