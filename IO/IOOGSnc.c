...
/* function to inquire BC size */
int ioogsnc_idx_(char *nomefile, char *nomedim, int *l )
{
      int i;
      int status, ncid, dimidp[1];
      int check=0;
...
int ioogsnc_ave_bkp_(char *nomefile, char *nmvar, int *iipao, int *jjpao, int *kkpao, float *tem_lon_f, float *tem_lat_f,  float *tem_lev_f,   char *datestart, char* date__end, double *tem_f, int *avecounter)
{
      int i;
      int status, ncid, dimidp[7];
      static char convenctions[] = "COARDS";
...
int ioogsnc_ave_3d2_(char *nomefile, char *nmvar, int *iipao, int *jjpao, int *kkpao, float *tem_lon_f, float *tem_lat_f,  float *tem_lev_f,   char *datestart, char* date__end, float *tem_f)
{
      int i;
      int status, ncid, dimidp[7];
      static char convenctions[] = "COARDS";
...
int get_att_int_(char *nomefile,char*attname, int* res) {
...
int get_att_char_(char *nomefile,char*attname, char* res) {
...
int ioogsnc_rst2_(char *nomefile, char *nmvarb, char *nmvarn, int *iipao, int *jjpao, int *kkpao, double *tem_lon, double *tem_lat,  double *tem_lev, double *tem_tim, double *tem_bck, double *tem_nxt )
{
      int i;
      int status, ncid, dimidp[7];
      int  varidp[8],varidp1;
...
int ioogsnc_bc_1d2_(char *nomefile, char *nomevar, int *kkpao, double *tem )
{
      int i;
      int status, ncid; /*dimidp[4]; */
      int  varidp,varidp1;
