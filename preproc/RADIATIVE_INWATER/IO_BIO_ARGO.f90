...
! ************************************************************
       ...
       SUBROUTINE OPEN_AVE_edeseu(fileNetCDF, NLEV, VAR1, VAR2, VAR3, VAR4, nc)
       USE netcdf
       ...
       character*(*),intent(in) :: VAR1, VAR2, VAR3, VAR4
       ...
       integer :: time_id, depth_id, nid, solzid

       integer :: idVAR1, idVAR2, idVAR3, idVAR4
        ...
        s= nf90_def_dim(nc,'solz'  , 1,   solzid)
        ...
        s = nf90_def_var(nc,trim(VAR4) , nf90_double, (/solzid/), idVAR4)
        ...
        s = nf90_put_att(nc,idVAR4, 'missing_value' ,1.e+20)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
       ...
       SUBROUTINE WRITE_AVE_edeseu(fileNetCDF, nc, NLEV, VAR1, VAR2, VAR3, VAR4, M1_0, M2_0, M3_0, M1, M2, M3, M4)
       USE netcdf
       IMPLICIT NONE
       integer, parameter :: nlt    = 33
