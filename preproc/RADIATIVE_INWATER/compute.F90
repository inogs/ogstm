...
call OPEN_AVE_edeseu(TRIM(OUTPUT_FILE), jpk,  'Edz', 'Esz', 'Euz', 'solz', nc)
...
call WRITE_AVE_edeseu(TRIM(OUTPUT_FILE), nc, jpk, 'Edz', 'Esz', 'Euz', 'solz', Ed_0m, Es_0m, Eu_0m, Edz, Esz, Euz, solz)
