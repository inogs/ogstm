...
wl_argo  = np.array([250.    , 325.     , 350.    , 375.    , 380.    , 400.     , 412.     , 425.        , 
	                 450.    , 475.     , 490.    , 500.    , 525.    , 550.     , 575.     , 600.        , 
	                 625.    , 650.     , 675.    , 700.    , 725.    , 775.     , 850.     , 950.        , 
...
# Adding BGC-Argo wavelengths

aw_OASIM_argo = np.interp(wl_argo, wl, aw_OASIM)
aw_LIT_argo   = np.interp(wl_argo, wl, aw_LIT)
aw_MASON_argo = np.interp(wl_argo, wl, aw_MASON)
bw_argo       = np.interp(wl_argo, wl, bw)

idx_380       = np.where(wl_argo == 380.)[0]
