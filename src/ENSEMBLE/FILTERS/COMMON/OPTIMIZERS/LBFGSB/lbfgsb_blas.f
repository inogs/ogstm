...
c
c       double precision function lbfgsb_dnrm2(n,x,incx)
c
c     where
c
...
c     **********
   ...
   10 continue
      ...
      do 20 i = 1, n, incx
         lbfgsb_dnrm2 = lbfgsb_dnrm2 + (x(i)/scale)**2
   20 continue

      lbfgsb_dnrm2 = scale*sqrt(lbfgsb_dnrm2)
...
c
   ...
   50 continue
   60 lbfgsb_ddot = dtemp
      return
      end
      
c====================== The end of lbfgsb_ddot ================================
