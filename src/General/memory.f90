...
!      njmpp=1
     ...
     allocate(gdept(jpk,jpj,jpi))
      ...
      !$acc enter data create(spongeVel)
...
!!    photoperiod
      ...
      mem_all=get_mem(err) - aux_mem
        ...
        subroutine clean_memory()
            ...
            !$acc exit data delete(spongeVel)
            ...
            deallocate(flx)
            !$acc exit data delete(tdta)
            deallocate(tdta)
            !$acc exit data delete(sdta)
            deallocate(sdta)
            !$acc exit data delete(e3tdta)
            deallocate(e3tdta)
            !$acc exit data delete(e3udta)
            deallocate(e3udta)
            !$acc exit data delete(e3vdta)
            deallocate(e3vdta)
            !$acc exit data delete(e3wdta)
            deallocate(e3wdta)
