...
# TIN 
    ...
    riv_N1p=np.zeros(tin_idxt,dtype=float); riv_N1p[0]=0. #0.35*10**(-5)
    riv_N3n=np.zeros(tin_idxt,dtype=float); riv_N3n[0]=0. #0.2*10**(-3)
    riv_N5s=np.zeros(tin_idxt,dtype=float); riv_N5s[0]=0. #1.0*10**(-4)
    riv_O3c=np.zeros(tin_idxt,dtype=float); riv_O3c[0]=0. #0.35
    riv_O3h=np.zeros(tin_idxt,dtype=float); riv_O3h[0]=0. #0.01
