...
def create_forcings_nc(test):
    ...
    Av=np.ones((jpk,jpj,jpi),float)
    Au=np.ones((jpk,jpj,jpi),float)
    ...
    D3T=np.zeros((1,jpk,jpj,jpi),float)
    D3S=np.zeros((1,jpk,jpj,jpi),float)
    D3K=np.zeros((1,jpk,jpj,jpi),float)

    D2Q=np.zeros((1,jpj,jpi),float)
    D2W=np.zeros((1,jpj,jpi),float)
    D2H=np.zeros((1,jpj,jpi),float)
    D2F=np.zeros((1,jpj,jpi),float)

    D3U=np.zeros((1,jpk,jpj,jpi),float)
    D3V=np.zeros((1,jpk,jpj,jpi),float)
    D3W=np.zeros((1,jpk,jpj,jpi),float)
