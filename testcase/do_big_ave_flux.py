...
def do_big_ave_flux(test, POSTPROC_DIR):
...
#        DIR_DATA          = '/pico/scratch/userexternal/plazzari/TILMAN/ogstm/testcase/TEST01/wrkdir/MODEL/' + 'AVE_FREQ_1/'
         ...
         if check_bool == 0:
             ...
             outfile = POSTPROC_DIR + '/' + test['BIO-FLOAT'] + '_flux.nc'
         ...
         for nf,fname in enumerate(SingleVar_filelist):
             ...
             DATA.close()
         ncvar = ncOUT.createVariable(var       ,'f',('time','depth','Type'),zlib=True); ncvar[:] = matrix; 
